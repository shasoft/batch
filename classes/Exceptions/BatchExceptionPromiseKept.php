...
// Исключение
class BatchExceptionPromiseKept extends BatchException
{
    // Конструктор
    public function __construct(protected BatchPromiseContext $promiseContext)
    {
        parent::__construct($promiseContext->managerContext, 'Выполняется выполненное обещание ' . CDumpHtml::toString($promiseContext));
    }
}
