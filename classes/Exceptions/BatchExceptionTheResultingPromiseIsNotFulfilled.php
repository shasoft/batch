...
// Исключение
class BatchExceptionTheResultingPromiseIsNotFulfilled extends BatchException
{
    // Конструктор
    public function __construct(protected BatchPromiseContext $promiseContext)
    {
        parent::__construct($promiseContext->managerContext, 'Результирующее обещание ' . CDumpHtml::toString($promiseContext) . ' не выполнено');
    }
}
